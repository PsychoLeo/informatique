...
class NeuralNetwork:
    ...
    def train(self, training_inputs, training_outputs, training_iterations):
        for i in range(training_iterations):
            ...
            adjustements = np.dot(training_inputs.T, error * self.sigmoid_derivative(output))
            self.synaptic_weights += adjustements
...
if __name__ == '__main__':
    ...
    print(f'Input situation : {a} {b} {c}')
    print(f'Result after training : {neural_network.think(np.array([a, b, c]))}')
